...
export class WecomService implements OnApplicationBootstrap {
  ...
  constructor(
    ...
    this.MENU_MAP = {
      ...
      '#sendmsg#_0_0#7599824568204779': '今日日期',
      '#sendmsg#_0_0#7599824568204780': '今日头条',
      '#sendmsg#_0_0#7599824568204781': '今日英语',
      '#sendmsg#_0_0#7599824568204777': '今日一言',
      '#sendmsg#_1_0#7599827764207063': '故事大全',
      '#sendmsg#_1_0#7599827764207067': '雷人笑话',
      '#sendmsg#_1_0#7599827764207068': '每日简报',
      '#sendmsg#_1_0#7599827764207070': '土味情话',
      '#sendmsg#_1_0#7599827764207069': '最美宋词',
    };
  }
